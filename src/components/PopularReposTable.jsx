        ...
        <table className="min-w-full text-sm">
          <thead className="bg-gray-50 text-gray-600">
            <tr>
              ...
              <th className="px-4 py-3" onClick={() => setSortKey("stars")}>
                Stars
              </th>
              <th className="px-4 py-3" onClick={() => setSortKey("forks")}>
                Forks
              </th>
              <th className="px-4 py-3" onClick={() => setSortKey("watchers")}>
                Watchers
              </th>
              <th className="px-4 py-3" onClick={() => setSortKey("issues")}>
                Issues
              </th>
              <th className="px-4 py-3" onClick={() => setSortKey("updated")}>
                Updated
              </th>
              <th className="px-4 py-3" onClick={() => setSortKey("action")}>
                Action
              </th>
            </tr>
          </thead>
